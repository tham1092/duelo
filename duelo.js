...
class Unit extends Card {
  ...
  stats() {
    console.log(
      `${this.nombre}, ${this.costo}, ${this.poder}, ${this.resiliencia}`
    );
  }
}
...
const rechazoDePromesanoMAnejado = new Effect(
...
const programacionEnPareja = new Effect(
...
console.log(
  "EL NINJA CINTURON ROJO SE JUEGA SU ÚLTIMA CARTA PARA INTENTAR GANAR ESTA BATALLA..."
);
